...
namespace AcubeSATParameters {
    ...
    enum ParameterID : uint16_t {
        ...
        EPS_VIP_VOLT_BRDSUP_ENG = 3063,
        EPS_VIP_CURR_BRDSUP_ENG = 3064,
        EPS_VIP_POWE_BRDSUP_ENG = 3065,
        EPS_VIP_TEMP_MCU_ENG = 3066,
        EPS_VIP_VOLT_INPUT_ENG = 3067,
        EPS_VIP_CURR_INPUT_ENG = 3068,
        EPS_VIP_POWE_INPUT_ENG = 3069,
        EPS_VIP_VOLT_DIST_INPUT_ENG = 3070,
        EPS_VIP_CURR_DIST_INPUT_ENG = 3071,
        EPS_VIP_POWE_DIST_INPUT_ENG = 3072,
        EPS_VIP_VOLT_BAT_INPUT_ENG = 3073,
        EPS_VIP_CURR_BAT_INPUT_ENG = 3074,
        EPS_VIP_POWE_BAT_INPUT_ENG = 3075,
        EPS_VIP_VOLT_VD0_ENG = 3076,
        EPS_VIP_CURR_VD0_ENG = 3077,
        EPS_VIP_POWE_VD0_ENG = 3078,
        EPS_VIP_VOLT_VD1_ENG = 3079,
        EPS_VIP_CURR_VD1_ENG = 3080,
        EPS_VIP_POWE_VD1_ENG = 3081,
        EPS_VIP_VOLT_VD2_ENG = 3082,
        EPS_VIP_CURR_VD2_ENG = 3083,
        EPS_VIP_POWE_VD2_ENG = 3084,
        EPS_VIP_VOLT_VD3_ENG = 3085,
        EPS_VIP_CURR_VD3_ENG = 3086,
        EPS_VIP_POWE_VD3_ENG = 3087,
        EPS_VIP_VOLT_VD4_ENG = 3088,
        EPS_VIP_CURR_VD4_ENG = 3089,
        EPS_VIP_POWE_VD4_ENG = 3090,
        EPS_VIP_VOLT_VD5_ENG = 3091,
        EPS_VIP_CURR_VD5_ENG = 3092,
        EPS_VIP_POWE_VD5_ENG = 3093,
        EPS_VIP_VOLT_VD6_ENG = 3094,
        EPS_VIP_CURR_VD6_ENG = 3095,
        EPS_VIP_POWE_VD6_ENG = 3096,
        EPS_VIP_VOLT_BRDSUP_RA = 3097,
        EPS_VIP_CURR_BRDSUP_RA = 3098,
        EPS_VIP_POWE_BRDSUP_RA = 3099,
        EPS_VIP_TEMP_MCU_RA = 3100,
        EPS_VIP_VOLT_INPUT_RA = 3101,
        EPS_VIP_CURR_INPUT_RA = 3102,
        EPS_VIP_POWE_INPUT_RA = 3103,
        EPS_VIP_VOLT_DIST_INPUT_RA = 3104,
        EPS_VIP_CURR_DIST_INPUT_RA = 3105,
        EPS_VIP_POWE_DIST_INPUT_RA = 3106,
        EPS_VIP_VOLT_BAT_INPUT_RA = 3107,
        EPS_VIP_CURR_BAT_INPUT_RA = 3108,
        EPS_VIP_POWE_BAT_INPUT_RA = 3109,
        EPS_VIP_VOLT_VD0_RA = 3110,
        EPS_VIP_CURR_VD0_RA = 3111,
        EPS_VIP_POWE_VD0_RA = 3112,
        EPS_VIP_VOLT_VD1_RA = 3113,
        EPS_VIP_CURR_VD1_RA = 3114,
        EPS_VIP_POWE_VD1_RA = 3115,
        EPS_VIP_VOLT_VD2_RA = 3116,
        EPS_VIP_CURR_VD2_RA = 3117,
        EPS_VIP_POWE_VD2_RA = 3118,
        EPS_VIP_VOLT_VD3_RA = 3119,
        EPS_VIP_CURR_VD3_RA = 3120,
        EPS_VIP_POWE_VD3_RA = 3121,
        EPS_VIP_VOLT_VD4_RA = 3122,
        EPS_VIP_CURR_VD4_RA = 3123,
        EPS_VIP_POWE_VD4_RA = 3124,
        EPS_VIP_VOLT_VD5_RA = 3125,
        EPS_VIP_CURR_VD5_RA = 3126,
        EPS_VIP_POWE_VD5_RA = 3127,
        EPS_VIP_VOLT_VD6_RA = 3128,
        EPS_VIP_CURR_VD6_RA = 3129,
        EPS_VIP_POWE_VD6_RA = 3130,
        EPS_STAT_BU = 3131,
        EPS_VOLT_BP1_INPUT_RAW = 3132,
        EPS_CURR_BP1_INPUT_RAW = 3133,
        EPS_POWE_BP1_INPUT_RAW = 3134,
        EPS_STAT_BP1_RAW = 3135,
        EPS_VOLT_BP1_CELL1_RAW = 3136,
        EPS_VOLT_BP1_CELL2_RAW = 3137,
        EPS_VOLT_BP1_CELL3_RAW = 3138,
        EPS_VOLT_BP1_CELL4_RAW = 3139,
        EPS_BAT_TEMP1_BP1_RAW = 3140,
        EPS_BAT_TEMP2_BP1_RAW = 3141,
        EPS_BAT_TEMP3_BP1_RAW = 3142,
        EPS_VOLT_BP2_INPUT_RAW = 3143,
        EPS_CURR_BP2_INPUT_RAW = 3144,
        EPS_POWE_BP2_INPUT_RAW = 3145,
        EPS_STAT_BP2_RAW = 3146,
        EPS_VOLT_BP2_CELL1_RAW = 3147,
        EPS_VOLT_BP2_CELL2_RAW = 3148,
        EPS_VOLT_BP2_CELL3_RAW = 3149,
        EPS_VOLT_BP2_CELL4_RAW = 3150,
        EPS_BAT_TEMP1_BP2_RAW = 3151,
        EPS_BAT_TEMP2_BP2_RAW = 3152,
        EPS_BAT_TEMP3_BP2_RAW = 3153,
        EPS_VOLT_BP3_INPUT_RAW = 3154,
        EPS_CURR_BP3_INPUT_RAW = 3155,
        EPS_POWE_BP3_INPUT_RAW = 3156,
        EPS_STAT_BP3_RAW = 3157,
        EPS_VOLT_BP3_CELL1_RAW = 3158,
        EPS_VOLT_BP3_CELL2_RAW = 3159,
        EPS_VOLT_BP3_CELL3_RAW = 3160,
        EPS_VOLT_BP3_CELL4_RAW = 3161,
        EPS_BAT_TEMP1_BP3_RAW = 3162,
        EPS_BAT_TEMP2_BP3_RAW = 3163,
        EPS_BAT_TEMP3_BP3_RAW = 3164,
        EPS_VOLT_BP1_INPUT_ENG = 3165,
        EPS_CURR_BP1_INPUT_ENG = 3166,
        EPS_POWE_BP1_INPUT_ENG = 3167,
        EPS_STAT_BP1_ENG = 3168,
        EPS_VOLT_BP1_CELL1_ENG = 3169,
        EPS_VOLT_BP1_CELL2_ENG = 3170,
        EPS_VOLT_BP1_CELL3_ENG = 3171,
        EPS_VOLT_BP1_CELL4_ENG = 3172,
        EPS_BAT_TEMP1_BP1_ENG = 3173,
        EPS_BAT_TEMP2_BP1_ENG = 3174,
        EPS_BAT_TEMP3_BP1_ENG = 3175,
        EPS_VOLT_BP2_INPUT_ENG = 3176,
        EPS_CURR_BP2_INPUT_ENG = 3177,
        EPS_POWE_BP2_INPUT_ENG = 3178,
        EPS_STAT_BP2_ENG = 3179,
        EPS_VOLT_BP2_CELL1_ENG = 3180,
        EPS_VOLT_BP2_CELL2_ENG = 3181,
        EPS_VOLT_BP2_CELL3_ENG = 3182,
        EPS_VOLT_BP2_CELL4_ENG = 3183,
        EPS_BAT_TEMP1_BP2_ENG = 3184,
        EPS_BAT_TEMP2_BP2_ENG = 3185,
        EPS_BAT_TEMP3_BP2_ENG = 3186,
        EPS_VOLT_BP3_INPUT_ENG = 3187,
        EPS_CURR_BP3_INPUT_ENG = 3188,
        EPS_POWE_BP3_INPUT_ENG = 3189,
        EPS_STAT_BP3_ENG = 3190,
        EPS_VOLT_BP3_CELL1_ENG = 3191,
        EPS_VOLT_BP3_CELL2_ENG = 3192,
        EPS_VOLT_BP3_CELL3_ENG = 3193,
        EPS_VOLT_BP3_CELL4_ENG = 3194,
        EPS_BAT_TEMP1_BP3_ENG = 3195,
        EPS_BAT_TEMP2_BP3_ENG = 3196,
        EPS_BAT_TEMP3_BP3_ENG = 3197,
        EPS_VOLT_BP1_INPUT_RA = 3198,
        EPS_CURR_BP1_INPUT_RA = 3199,
        EPS_POWE_BP1_INPUT_RA = 3200,
        EPS_STAT_BP1_RA = 3201,
        EPS_VOLT_BP1_CELL1_RA = 3202,
        EPS_VOLT_BP1_CELL2_RA = 3203,
        EPS_VOLT_BP1_CELL3_RA = 3204,
        EPS_VOLT_BP1_CELL4_RA = 3205,
        EPS_BAT_TEMP1_BP1_RA = 3206,
        EPS_BAT_TEMP2_BP1_RA = 3207,
        EPS_BAT_TEMP3_BP1_RA = 3208,
        EPS_VOLT_BP2_INPUT_RA = 3209,
        EPS_CURR_BP2_INPUT_RA = 3210,
        EPS_POWE_BP2_INPUT_RA = 3211,
        EPS_STAT_BP2_RA = 3212,
        EPS_VOLT_BP2_CELL1_RA = 3213,
        EPS_VOLT_BP2_CELL2_RA = 3214,
        EPS_VOLT_BP2_CELL3_RA = 3215,
        EPS_VOLT_BP2_CELL4_RA = 3216,
        EPS_BAT_TEMP1_BP2_RA = 3217,
        EPS_BAT_TEMP2_BP2_RA = 3218,
        EPS_BAT_TEMP3_BP2_RA = 3219,
        EPS_VOLT_BP3_INPUT_RA = 3220,
        EPS_CURR_BP3_INPUT_RA = 3221,
        EPS_POWE_BP3_INPUT_RA = 3222,
        EPS_STAT_BP3_RA = 3223,
        EPS_VOLT_BP3_CELL1_RA = 3224,
        EPS_VOLT_BP3_CELL2_RA = 3225,
        EPS_VOLT_BP3_CELL3_RA = 3226,
        EPS_VOLT_BP3_CELL4_RA = 3227,
        EPS_BAT_TEMP1_BP3_RA = 3228,
        EPS_BAT_TEMP2_BP3_RA = 3229,
        EPS_BAT_TEMP3_BP3_RA = 3230,
        EPS_VOLT_VD0_RAW = 3231,
        EPS_VOLT_VD1_RAW = 3232,
        EPS_VOLT_VD2_RAW = 3233,
        EPS_VOLT_VD0_ENG = 3234,
        EPS_VOLT_VD1_ENG = 3235,
        EPS_VOLT_VD2_ENG = 3236,
        EPS_VOLT_VD0_RA = 3237,
        EPS_VOLT_VD1_RA = 3238,
        EPS_VOLT_VD2_RA = 3239,
        EPS_BAT_STAT = 3240,
        EPS_BAT_TEMP2_RAW = 3241,
        EPS_BAT_TEMP3_RAW = 3242,
        EPS_BAT_TEMP2_ENG = 3243,
        EPS_BAT_TEMP3_ENG = 3244,
        EPS_BAT_TEMP2_RA = 3245,
        EPS_BAT_TEMP3_RA = 3246,
        EPS_CC1_VOLT_IN_MPPT_RAW = 3247,
        EPS_CC2_VOLT_IN_MPPT_RAW = 3248,
        EPS_CC3_VOLT_IN_MPPT_RAW = 3249,
        EPS_CC4_VOLT_IN_MPPT_RAW = 3250,
        EPS_CC5_VOLT_IN_MPPT_RAW = 3251,
        EPS_CC1_CURR_IN_MPPT_RAW = 3252,
        EPS_CC2_CURR_IN_MPPT_RAW = 3253,
        EPS_CC3_CURR_IN_MPPT_RAW = 3254,
        EPS_CC4_CURR_IN_MPPT_RAW = 3255,
        EPS_CC5_CURR_IN_MPPT_RAW = 3256,
        EPS_CC1_VOLT_OU_MPPT_RAW = 3257,
        EPS_CC2_VOLT_OU_MPPT_RAW = 3258,
        EPS_CC3_VOLT_OU_MPPT_RAW = 3259,
        EPS_CC4_VOLT_OU_MPPT_RAW = 3260,
        EPS_CC5_VOLT_OU_MPPT_RAW = 3261,
        EPS_CC1_CURR_OU_MPPT_RAW = 3262,
        EPS_CC2_CURR_OU_MPPT_RAW = 3263,
        EPS_CC3_CURR_OU_MPPT_RAW = 3264,
        EPS_CC4_CURR_OU_MPPT_RAW = 3265,
        EPS_CC5_CURR_OU_MPPT_RAW = 3266,
        EPS_CC1_VOLT_IN_MPPT_ENG = 3267,
        EPS_CC2_VOLT_IN_MPPT_ENG = 3268,
        EPS_CC3_VOLT_IN_MPPT_ENG = 3269,
        EPS_CC4_VOLT_IN_MPPT_ENG = 3270,
        EPS_CC5_VOLT_IN_MPPT_ENG = 3271,
        EPS_CC1_CURR_IN_MPPT_ENG = 3272,
        EPS_CC2_CURR_IN_MPPT_ENG = 3273,
        EPS_CC3_CURR_IN_MPPT_ENG = 3274,
        EPS_CC4_CURR_IN_MPPT_ENG = 3275,
        EPS_CC5_CURR_IN_MPPT_ENG = 3276,
        EPS_CC1_VOLT_OU_MPPT_ENG = 3277,
        EPS_CC2_VOLT_OU_MPPT_ENG = 3278,
        EPS_CC3_VOLT_OU_MPPT_ENG = 3279,
        EPS_CC4_VOLT_OU_MPPT_ENG = 3280,
        EPS_CC5_VOLT_OU_MPPT_ENG = 3281,
        EPS_CC1_CURR_OU_MPPT_ENG = 3282,
        EPS_CC2_CURR_OU_MPPT_ENG = 3283,
        EPS_CC3_CURR_OU_MPPT_ENG = 3284,
        EPS_CC4_CURR_OU_MPPT_ENG = 3285,
        EPS_CC5_CURR_OU_MPPT_ENG = 3286,
        EPS_CC1_VOLT_IN_MPPT_RA = 3287,
        EPS_CC2_VOLT_IN_MPPT_RA = 3288,
        EPS_CC3_VOLT_IN_MPPT_RA = 3289,
        EPS_CC4_VOLT_IN_MPPT_RA = 3290,
        EPS_CC5_VOLT_IN_MPPT_RA = 3291,
        EPS_CC1_CURR_IN_MPPT_RA = 3292,
        EPS_CC2_CURR_IN_MPPT_RA = 3293,
        EPS_CC3_CURR_IN_MPPT_RA = 3294,
        EPS_CC4_CURR_IN_MPPT_RA = 3295,
        EPS_CC5_CURR_IN_MPPT_RA = 3296,
        EPS_CC1_VOLT_OU_MPPT_RA = 3297,
        EPS_CC2_VOLT_OU_MPPT_RA = 3298,
        EPS_CC3_VOLT_OU_MPPT_RA = 3299,
        EPS_CC4_VOLT_OU_MPPT_RA = 3300,
        EPS_CC5_VOLT_OU_MPPT_RA = 3301,
        EPS_CC1_CURR_OU_MPPT_RA = 3302,
        EPS_CC2_CURR_OU_MPPT_RA = 3303,
        EPS_CC3_CURR_OU_MPPT_RA = 3304,
        EPS_CC4_CURR_OU_MPPT_RA = 3305,
        EPS_CC5_CURR_OU_MPPT_RA = 3306,
        EPS_CH_STARTUP_ENA_BF = 3307,
        EPS_CH_STARTUP_KEY = 3308,
        EPS_CH_LATCHOFF_ENA_BF = 3309,
        EPS_CH_LATCHOFF_KEY = 3310,
        EPS_TTC_WDG_TIMEOUT = 3311,
        EPS_TTC_WDG_TIMEOUT_KEY = 3312,
        EPS_CH_STARTUP_DELAY_CH1 = 3313,
        EPS_CH_LATCHOFF_DELAY_CH1 = 3314,
        EPS_SAFETY_VOLT_LOTHR = 3315,
        EPS_SAFETY_VOLT_HITHR = 3316,
        EPS_LOTHR_BP1_HEATER = 3317,
        EPS_LOTHR_BP2_HEATER = 3318,
        EPS_LOTHR_BP3_HEATER = 3319,
        EPS_HITHR_BP1_HEATER = 3320,
        EPS_HITHR_BP2_HEATER = 3321,
        EPS_HITHR_BP3_HEATER = 3322,
        EPS_LOTHR_BP1_UNBAL = 3323,
        EPS_LOTHR_BP2_UNBAL = 3324,
        EPS_LOTHR_BP3_UNBAL = 3325,
        EPS_HITHR_BP1_UNBAL = 3326,
        EPS_HITHR_BP2_UNBAL = 3327,
        EPS_HITHR_BP3_UNBAL = 3328,
        EPS_MCU_TEMP_BIAS = 3329,
        EPS_MCU_TEMP_PREMUL = 3330,
        EPS_MCU_TEMP_POSDIV = 3331,
        EPS_BP1_TEMP1_BIAS = 3332,
        EPS_BP1_TEMP2_BIAS = 3333,
        EPS_BP1_TEMP3_BIAS = 3334,
        EPS_BP2_TEMP1_BIAS = 3335,
        EPS_BP2_TEMP2_BIAS = 3336,
        EPS_BP2_TEMP3_BIAS = 3337,
        EPS_BP3_TEMP1_BIAS = 3338,
        EPS_BP3_TEMP2_BIAS = 3339,
        EPS_BP3_TEMP3_BIAS = 3340,
        EPS_BP1_TEMP1_PREMUL = 3341,
        EPS_BP1_TEMP2_PREMUL = 3342,
        EPS_BP1_TEMP3_PREMUL = 3343,
        EPS_BP2_TEMP1_PREMUL = 3344,
        EPS_BP2_TEMP2_PREMUL = 3345,
        EPS_BP2_TEMP3_PREMUL = 3346,
        EPS_BP3_TEMP1_PREMUL = 3347,
        EPS_BP3_TEMP2_PREMUL = 3348,
        EPS_BP3_TEMP3_PREMUL = 3349,
        EPS_BP1_TEMP1_POSDIV = 3350,
        EPS_BP1_TEMP2_POSDIV = 3351,
        EPS_BP1_TEMP3_POSDIV = 3352,
        EPS_BP2_TEMP1_POSDIV = 3353,
        EPS_BP2_TEMP2_POSDIV = 3354,
        EPS_BP2_TEMP3_POSDIV = 3355,
        EPS_BP3_TEMP1_POSDIV = 3356,
        EPS_BP3_TEMP2_POSDIV = 3357,
        EPS_BP3_TEMP3_POSDIV = 3358,
        EPS_BOARD_IDENTIFIER = 3359,
        EPS_BOARD_IDENTIFIER_KEY = 3360,
        EPS_RAVG_STRENGTH_P2 = 3361,
        EPS_AUTO_HEAT_ENA_BP1 = 3362,
        EPS_AUTO_HEAT_ENA_BP2 = 3363,
        EPS_AUTO_HEAT_ENA_BP3 = 3364,
        EPS_AUTO_BAL_ENA_BP1 = 3365,
        EPS_AUTO_BAL_ENA_BP2 = 3366,
        EPS_AUTO_BAL_ENA_BP3 = 3367,
        EPS_VD1_ALWAYS_ENA = 3368,
        EPS_VD1_ALWAYS_DISA = 3369,
        EPS_CH_FORCE_ENA_USE_BF = 3370,
        EPS_CH_STARTUP_ENA_USE_BF = 3371,
        EPS_CH_LATCHOFF_ENA_USE_BF = 3372,
        EPS_VD1_ALLOC_CH_BF = 3373,
        EPS_SWCI_CH_CMD_ENA_BF = 3374,
        EPS_SWCI_CH_CMD_DISA_BF = 3375,
        EPS_TTC_I2C_SLAVE_ADDR = 3376,
        EPS_CONF_NVM_SAVE_CNTR = 3377,
        EPS_CONF_NVM_SAVE_CHKS = 3378,
        EPS_RST_CAUSE = 3379,
        EPS_RST_CNTR_PWRON = 3380,
        EPS_RST_CNTR_WDG = 3381,
        EPS_RST_CNTR_CMD = 3382,
        EPS_RST_CNTR_MCU = 3383,
        EPS_RST_CNTR_EMLOPO = 3384,
        EPS_RST_CODE_MCU_RAW = 3385,
        EPS_EMLOPO_VOLT_LOTHR = 3386,
        EPS_EMLOPO_VOLT_HITHR = 3387,
        EPS_EMLOPO_PERIOD = 3388,
        EPS_SAFETY_VOLT_LOTHR_USED = 3389,
        EPS_SAFETY_VOLT_HITHR_USED = 3390,
        EPS_SAFETY_LINGER = 3391,
        EPS_TTC_WDG_TIMOUT_USED = 3392,
        EPS_TTC_PREVCMD_ELAPSED = 3393,
        EPS_ADC_MCU_TEMP_V25T30 = 3394,
        EPS_ADC_MCU_TEMP_V25T85 = 3395,
        EPS_STID = 3396,
        EPS_IVID = 3397,
        EPS_BID_USED = 3398,
        EPS_BOOT_RESUME_SHORT = 3399,
        EPS_CONF_PARAM_CHANGED = 3400,
    ...
    inline Parameter<int16_t> epsVIP_INPUT_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_INPUT_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_INPUT_POWE_RAW(0);

    inline Parameter<int16_t> epsDIST_INPUT_VOLT_RAW(0);
    inline Parameter<int16_t> epsDIST_INPUT_CURR_RAW(0);
    inline Parameter<int16_t> epsDIST_INPUT_POWE_RAW(0);

    inline Parameter<int16_t> epsVIP_BAT_INPUT_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_BAT_INPUT_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_BAT_INPUT_POWE_RAW(0);

    inline Parameter<int16_t> epsVIP_INPUT_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_INPUT_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_INPUT_POWE_ENG(0);

    inline Parameter<int16_t> epsDIST_INPUT_VOLT_ENG(0);
    inline Parameter<int16_t> epsDIST_INPUT_CURR_ENG(0);
    inline Parameter<int16_t> epsDIST_INPUT_POWE_ENG(0);

    inline Parameter<int16_t> epsVIP_BAT_INPUT_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_BAT_INPUT_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_BAT_INPUT_POWE_ENG(0);

    inline Parameter<int16_t> epsVIP_INPUT_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_INPUT_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_INPUT_POWE_RA(0);

    inline Parameter<int16_t> epsDIST_INPUT_VOLT_RA(0);
    inline Parameter<int16_t> epsDIST_INPUT_CURR_RA(0);
    inline Parameter<int16_t> epsDIST_INPUT_POWE_RA(0);

    inline Parameter<int16_t> epsVIP_BAT_INPUT_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_BAT_INPUT_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_BAT_INPUT_POWE_RA(0);

    inline Parameter<int16_t> epsVIP_VD0_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD0_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD0_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD1_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD1_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD1_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD2_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD2_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD2_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD3_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD3_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD3_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD4_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD4_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD4_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD5_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD5_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD5_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD6_VOLT_RAW(0);
    inline Parameter<int16_t> epsVIP_VD6_CURR_RAW(0);
    inline Parameter<int16_t> epsVIP_VD6_POWE_RAW(0);
    inline Parameter<int16_t> epsVIP_VD0_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD0_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD0_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD1_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD1_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD1_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD2_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD2_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD2_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD3_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD3_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD3_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD4_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD4_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD4_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD5_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD5_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD5_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD6_VOLT_ENG(0);
    inline Parameter<int16_t> epsVIP_VD6_CURR_ENG(0);
    inline Parameter<int16_t> epsVIP_VD6_POWE_ENG(0);
    inline Parameter<int16_t> epsVIP_VD0_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD0_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD0_POWE_RA(0);
    inline Parameter<int16_t> epsVIP_VD1_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD1_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD1_POWE_RA(0);
    inline Parameter<int16_t> epsVIP_VD2_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD2_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD2_POWE_RA(0);
    inline Parameter<int16_t> epsVIP_VD3_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD3_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD3_POWE_RA(0);
    inline Parameter<int16_t> epsVIP_VD4_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD4_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD4_POWE_RA(0);
    inline Parameter<int16_t> epsVIP_VD5_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD5_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD5_POWE_RA(0);
    inline Parameter<int16_t> epsVIP_VD6_VOLT_RA(0);
    inline Parameter<int16_t> epsVIP_VD6_CURR_RA(0);
    inline Parameter<int16_t> epsVIP_VD6_POWE_RA(0);
