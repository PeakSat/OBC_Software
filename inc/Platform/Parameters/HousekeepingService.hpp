    ...
    static etl::array<HousekeepingStructure, ECSSMaxHousekeepingStructures> structures = {
        {
            ...
            {
                3, 4000, true, {
                    EPS_CONF, EPS_IVID, EPS_MODE, EPS_STID, EPS_ERROR, EPS_RC_CNT_PWRON, EPS_RC_CNT_WDG, EPS_RC_CNT_CMD,
                    EPS_RC_CNT_MCU, EPS_RC_CNT_EMLOPO, EPS_PREVCMD_ELAPSED, EPS_UNIX_TIME, EPS_UNIX_YEAR,
                    EPS_UNIX_MONTH, EPS_UNIX_DAY, EPS_UNIX_HOUR, EPS_UNIX_MINUTE, EPS_UNIX_SECOND,
                }
            }
        }
    };
