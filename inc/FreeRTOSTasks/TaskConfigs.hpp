...
constexpr uint16_t CANGatekeeperTaskStack = 4000;
constexpr uint16_t CANParserTaskStack = 4500;
constexpr uint16_t HousekeepingTaskStack = 4000;
constexpr uint16_t MCUTemperatureTaskStack = 1000;
constexpr uint16_t PayloadTestTaskStack = 1000;
constexpr uint16_t StatisticsReportingTaskStack = 2000;
constexpr uint16_t TCHandlingTaskStack = 1000;
constexpr uint16_t TimeBasedSchedulingTaskStack = 1000;
constexpr uint16_t TimeKeepingTaskStack = 1000;
constexpr uint16_t PayloadGatekeeperTaskStack = 2500;
