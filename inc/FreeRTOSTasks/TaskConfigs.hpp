...
constexpr BaseType_t NANDTaskPriority = tskIDLE_PRIORITY + 2;
constexpr BaseType_t MemoryManagementTaskPriority = tskIDLE_PRIORITY + 2;
constexpr BaseType_t PayloadTestTaskPriority = tskIDLE_PRIORITY + 1;
